...
Monochrome cyan on dark background -- security/hacker terminal aesthetic.
...
OUT = sys.argv[2] if len(sys.argv) > 2 else os.path.join(HERE, "..", "moe-ascii.svg")
...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">moemairu@github: ~$ ./portrait.sh</text>')
